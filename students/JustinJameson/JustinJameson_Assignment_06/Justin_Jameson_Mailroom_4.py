...
# Justin Jameson, 02182019
# 1. corrected spelling errors.
# 2. added 'exit to main' in the 'send a thankyou' function by pressing enter.
# **************************
...
def main(mprompt, mdict):
    ...
    while True:
        ...
        try:
            ...
            print("You entered a letter, which in turn made a variable get called before it had been assigned.")

# End of main function.

def send_a_thankyou(thank_you_prompt, tdict):
    """
    ...
    :param thank_you_prompt: Argument fed into the function to give the thank you prompt options.
    ...
    while True:
        ...
        try:
            response = int(input(thank_you_prompt))  # continuously collect user selection
            v0 = thank_you_dict.get(response)
        except ValueError:
            print("You must input an integer.")
        try:
...
margdict = {1: [thankYouPrompt, dictThankYouPrompt],
            ...
            3: [listOfDonors, None],
            4: [None, None]}
thank_you_dict = {1: [listOfDonors, None],
                  2: [donorTableHeading, listOfDonors],
...
if __name__ == "__main__":
    # guards against Justin Jameson Mailroom code running automatically if this module is imported
    main(mainPrompt, dictMainPrompt)
>>>>>>> b8441ae17350c2dc4ead63b426e09b1fb548796c
